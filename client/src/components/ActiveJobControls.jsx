    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 spatial-panel rounded-3xl p-6 border border-white/90 dark:border-white/10 bg-white/75 dark:bg-slate-900/50 space-y-4 shadow-spatial-md">
          ...
          <div className="p-3 rounded-2xl bg-slate-50 dark:bg-white/[0.03] border border-slate-200/80 dark:border-white/5 text-xs text-slate-700 dark:text-slate-300 leading-relaxed font-medium">
            <span className="text-slate-500 font-bold block text-[10px] uppercase mb-1">
              Customer Problem Report:
            </span>
            {activeJob.details || 'Standard service request.'}
          </div>
          ...
          {activeJob.image && (
            <div>
              ...
              <div
                onClick={() => setSelectedImageModal(activeJob.image)}
                className="relative group rounded-xl overflow-hidden border border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-slate-800 cursor-pointer max-h-36 aspect-video flex items-center justify-center shadow-xs"
              >
                <img
                  src={activeJob.image}
